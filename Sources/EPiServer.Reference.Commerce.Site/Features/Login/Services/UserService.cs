...
{
    public class UserService : Domain.Services.UserService
    {
        ...
        //    }
        //}
        public UserService(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAuthenticationManager authenticationManager, LocalizationService localizationService, CustomerContextFacade customerContextFacade)
            : base(userManager, signInManager, authenticationManager, localizationService, customerContextFacade)
        {
        }
    }
}