...
namespace EPiServer.Reference.Commerce.Site.Features.Cart.Services
{
    ...
    public class CartFactory : Domain.Factories.CartFactory
    {
        public CartFactory(IContentLoader contentLoader, UrlResolver urlResolver, IProductService productService)
